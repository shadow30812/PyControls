...
class TestMathUtils(unittest.TestCase):
    ...
    def test_matrix_exponential_identity(self) -> None:
        """e^0 = I"""
        A = np.zeros((3, 3))
        expected = np.eye(3)
    ...
    def test_matrix_exponential_diagonal(self) -> None:
    ...
    def test_matrix_exponential_nilpotent(self) -> None:
    ...
    def test_matrix_exponential_rotation(self) -> None:
    ...
    def test_implicit_multiplication_basics(self) -> None:
    ...
    def test_implicit_multiplication_edge_cases(self) -> None:
    ...
    def test_preprocess_power(self) -> None:
    ...
    def test_root_brent_standard(self) -> None:
        r = Root()
        f = lambda x: x**2 - 4
        res = r.find_root(f, -1, 3)
        self.assertAlmostEqual(res, 2.0)

    def test_root_brent_bad_bracket(self) -> None:
    ...
    def test_root_newton_convergence(self) -> None:
        r = Root()
        f = lambda x: (x - 3) ** 2
        res = r.find_root(f, 10.0)
        self.assertAlmostEqual(res, 3.0, places=5)

    def test_root_newton_maxiter_exception(self) -> None:
    ...
    def test_diff_vectorized_input(self) -> None:
        diff = Differentiation()
        f = lambda x: x**2
    ...
    def test_find_root_fallback_returns_guess(self) -> None:
        r = Root()
        f = lambda x: x**2 + 1
        res = r.find_root(f, 10.0)
        self.assertEqual(res, 10.0)

    def test_make_system_func_batch_state(self) -> None:
        ...
        if isinstance(res, np.ndarray):
            ...
            self.skipTest("res is not a NumPy array")

    def test_diff_near_zero(self) -> None:
        diff = Differentiation()
        f = lambda x: x**3
        val = diff.real_diff(f, 1e-8)
        self.assertAlmostEqual(val, 3e-16, delta=1e-14)

    def test_real_diff_many_points_complex_step(self) -> None:
        diff = Differentiation()
    ...
    def test_real_diff_many_points_fallback(self) -> None:
        diff = Differentiation()
    ...
    def test_real_diff_mixed_behavior(self) -> None:
        diff = Differentiation()
...
class TestJacobian(unittest.TestCase):
    def test_jacobian_matches_analytic(self) -> None:
    ...
    def test_jacobian_high_dimension(self) -> None:
        n = 8
    ...
    def test_jacobian_fallback(self) -> None:
        def f(x: NDArray[np.float64]) -> NDArray[np.float64]:
